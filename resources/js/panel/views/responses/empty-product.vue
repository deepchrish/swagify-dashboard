  ...
  <div>
    ...
    <div class="flex">
      <div class="w-full sw-table">
        ...
        <vs-divider />
        <div class="flex flex-wrap">
          <div class="w-full text-center mt-10 mb-4">
            <h2>Here you will see all products you have designed.</h2>
          </div>
          <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/3 xl:w-1/3 m-auto text-center">
            <p
              class="text-grey"
            >When ready, start designing products. You can publish them directly to your stores, or save them for later in Storehubs.</p>
          </div>
        </div>
        <div class="flex flex-wrap pb-5">
          <div class="w-full px-5 py-2">
            <div class="p-4 flex flex-col text-center">
              <img class="img-responsive" src="@assets/images/pages/noproducts.svg" />
              <div class="mt-4">
                <vs-button color="primary" type="filled" class="sw-btn-primary">Start Desiging</vs-button>
              </div>
            </div>
          </div>
        </div>
